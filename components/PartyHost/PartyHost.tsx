...
const theater_img_array = ["theater_one_yellow", "theater_two_red", "theater_three_blue", "theater_four_white"];
const theater_names = ["Yellow Theater", "Red Theater", "Blue Theater", "White Theater"];
const theater_descriptions = ["A theater with bright yellow lines on the ceiling and colorful patterns on the walls.",
        ...
        {[1, 2, 3, 4].map((cardNum, idx) => (
          <Reveal delay={cardNum / 6} key={idx}>
            <div>
              ...
              />
              <div className="py-4">
                <h3 className="text-2xl font-semibold">{theater_names[idx]}</h3>
